...
## 🛠️ Compétences Techniques & Scientifiques

### Langages de programmation & Data Science

<div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 20px;">
  <span style="background: #306998; padding: 8px 20px; border-radius: 20px; color: white; font-weight: bold;">Python</span>
  <span style="background: #276DC3; padding: 8px 20px; border-radius: 20px; color: white; font-weight: bold;">R</span>
  <span style="background: #4479A1; padding: 8px 20px; border-radius: 20px; color: white; font-weight: bold;">SQL</span>
  <span style="background: #217346; padding: 8px 20px; border-radius: 20px; color: white; font-weight: bold;">Excel VBA</span>
  <span style="background: #F2C811; padding: 8px 20px; border-radius: 20px; color: #333; font-weight: bold;">Power BI</span>
  <span style="background: #E97627; padding: 8px 20px; border-radius: 20px; color: white; font-weight: bold;">Tableau</span>
</div>

### Data Science & Machine Learning

<div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 20px;">
  <span style="background: #FF6B6B; padding: 8px 20px; border-radius: 20px; color: white;">Régression (Linéaire/Logistique)</span>
  <span style="background: #4ECDC4; padding: 8px 20px; border-radius: 20px; color: white;">Séries Temporelles</span>
  <span style="background: #45B7D1; padding: 8px 20px; border-radius: 20px; color: white;">Machine Learning</span>
  <span style="background: #96CEB4; padding: 8px 20px; border-radius: 20px; color: #333;">Data Mining</span>
  <span style="background: #DDA0DD; padding: 8px 20px; border-radius: 20px; color: #333;">Analyse de Données Massives</span>
</div>

### Économétrie & Statistique

<div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 20px;">
  <span style="background: #2C3E50; padding: 8px 20px; border-radius: 20px; color: white;">Économétrie Avancée</span>
  <span style="background: #E74C3C; padding: 8px 20px; border-radius: 20px; color: white;">Statistique Bayésienne</span>
  <span style="background: #3498DB; padding: 8px 20px; border-radius: 20px; color: white;">Séries Chronologiques</span>
  <span style="background: #2ECC71; padding: 8px 20px; border-radius: 20px; color: white;">Modèles Linéaires Généralisés</span>
  <span style="background: #F39C12; padding: 8px 20px; border-radius: 20px; color: white;">Inférence Statistique</span>
</div>

### Outils & Environnements

<div style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 30px;">
  <span style="background: #333; padding: 8px 20px; border-radius: 20px; color: white;">Git & GitHub</span>
  <span style="background: #1A1A2E; padding: 8px 20px; border-radius: 20px; color: white;">STATA</span>
  <span style="background: #16213E; padding: 8px 20px; border-radius: 20px; color: white;">SPSS</span>
  <span style="background: #0F3460; padding: 8px 20px; border-radius: 20px; color: white;">LaTeX</span>
</div>
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 15px; margin: 20px 0;">
  ...
  <div style="background: #f0f8ff; padding: 18px; border-radius: 10px; border-left: 4px solid #007BFF;">
    ...
    <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/ARC-Agriculture.png" target="_blank" style="color: #007BFF; text-decoration: none; font-size: 0.8em;">📄 Voir le certificat</a>
  </div>
  ...
  <div style="background: #f0faf4; padding: 18px; border-radius: 10px; border-left: 4px solid #28A745;">
    ...
    <p style="font-size: 0.8em; color: #555;">Africa Research Center — Août 2026</p>
    <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/ARC-Energie.png" target="_blank" style="color: #28A745; text-decoration: none; font-size: 0.8em;">📄 Voir le certificat</a>
  </div>
  ...
  <div style="background: #fdf4f0; padding: 18px; border-radius: 10px; border-left: 4px solid #FD7E14;">
    ...
    <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/Deloitte.pdf" target="_blank" style="color: #FD7E14; text-decoration: none; font-size: 0.8em;">📄 Voir le certificat</a>
  </div>
  ...
  <div style="background: #fdf0f0; padding: 18px; border-radius: 10px; border-left: 4px solid #DC3545;">
    ...
    <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/TATA.pdf" target="_blank" style="color: #DC3545; text-decoration: none; font-size: 0.8em;">📄 Voir le certificat</a>
  </div>
  ...
  <div style="background: #f4f0f8; padding: 18px; border-radius: 10px; border-left: 4px solid #6F42C1;">
    ...
    <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/Coursera-R.pdf" target="_blank" style="color: #6F42C1; text-decoration: none; font-size: 0.8em;">📄 Voir le certificat</a>
  </div>
  ...
  <div style="background: #f0f8ff; padding: 18px; border-radius: 10px; border-left: 4px solid #17A2B8;">
    ...
    <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/Web_Scrapping.pdf" target="_blank" style="color: #17A2B8; text-decoration: none; font-size: 0.8em;">📄 Voir le certificat</a>
  </div>
...
<details style="margin: 15px 0; padding: 15px; background: #f8f9fa; border-radius: 10px;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 10px; margin-top: 15px;">
    ...
    <div style="background: white; padding: 12px; border-radius: 8px; border: 1px solid #ddd;">
      ...
      <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/Data-Analytics-Essentials.png" target="_blank" style="font-size: 0.75em; color: #007BFF;">Voir</a>
    </div>
    ...
    <div style="background: white; padding: 12px; border-radius: 8px; border: 1px solid #ddd;">
      ...
      <a href="https://guergou-debug.github.io/Guergou-Economiste-Chercheur/assets/images/documents/certificats/Entrepreneuriat.jpg" target="_blank" style="font-size: 0.75em; color: #007BFF;">Voir</a>
    </div>
