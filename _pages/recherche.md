---
title: "Recherche et Ambitions Scientifiques"
permalink: /recherche/
layout: single
author_profile: true
header:
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin: 30px 0;">
  ...
  **📊 Économétrie appliquée**
  ...
  Méthodes quantitatives pour l'analyse des politiques publiques dans les pays en développement
  </div>

  <div markdown="1" style="background: #f0faf4; padding: 20px; border-radius: 10px; border-left: 4px solid #28A745;">
  **🌍 Économie du développement**

  Inégalités, pauvreté, capital humain et transformation structurelle en Afrique
  </div>

  <div markdown="1" style="background: #fdf4f0; padding: 20px; border-radius: 10px; border-left: 4px solid #FD7E14;">
  **💼 Économie du travail**

  Marché du travail, emploi informel et politiques d'emploi au Sahel
  </div>

  <div markdown="1" style="background: #fdf0f0; padding: 20px; border-radius: 10px; border-left: 4px solid #DC3545;">
  **📈 Finance quantitative**

  Modélisation financière, risque et accès au financement dans les économies émergentes
  </div>

  <div markdown="1" style="background: #f4f0f8; padding: 20px; border-radius: 10px; border-left: 4px solid #6F42C1;">
  **🤖 Big Data & IA**

  Machine Learning, Text Mining et nouvelles sources de données pour l'économie
  </div>
...
*"La recherche en économie du développement a le pouvoir de transformer des vies. C'est cette conviction qui guide mon parcours scientifique."*
